...
Baltimore has the most variety. Some cities have 0 of certain groups, but Baltimore has all of them.
...
Summerfield, the overwhelming majority of their population is black.
...
I noticed that their Hispanic populations is close to half the population.
...
These cities are from adjacent counties, signifying that this region is more diverse.

Least diverse is Lake Shore in Anne Arundel County.
...
Headline: "Two cities in Prince George's County among the most diverse in the state."

Lede: 
Langley Park and Adelphi, Maryland take up two spots in the top 3 most diverse cities in Maryland. Using the USA Today Diversity Index, both cities had a score over 90, with Langley Park taking the top spot. The least diverse city in the state was Lake Shore in Anne Arundel County.
The index indicates the likelihood that two random people in a sample would not be the same race.
