...
This model is not worth using because the p-value shows there is a low significance. The only thing this equation tells us is that the relationship is weakly positive.
...
The largest differences are around a residual of +/-30. The lasgest absolute residual is Whitemarsh Elementary School with about 35.
...
There is no significant evidence in the data supporting the board member's claim. This itself could be a story pitch, disproving the board member's claims and examining what other factors might contribute to test scores.
