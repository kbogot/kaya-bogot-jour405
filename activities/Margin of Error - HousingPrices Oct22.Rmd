...
A better headline would be "Approximately Half Supports City Policy" because given the margin of error, the stats could fall under 50%.
...
Recent data shows that the new transit line in the DMV area has caused an increase in home prices. According to these numbers, the average housing cost has risen by nearly 6.8%. Previously, the average home cost $285K, now, however, that number has risen to $304.5K.
