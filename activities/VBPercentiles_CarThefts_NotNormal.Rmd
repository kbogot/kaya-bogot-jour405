...
**Your answer**:
It assumes a normal distribution because in random sampling, often times a trend/average occurs. One challenge that arises is that it can be difficult to accomplish truly random sampling. For example, if you try to accomplish random sampling by calling random people's homes, those most likely to have a land-line or at the very least answer to an unkown number, are usually older folks. Another example is if you are surveying house-hold income of people who have boats, they will usually be very wealthy.
When dealing with data that isn't normally distributed, reporters should be transparent about their sampling methods and be mindful to adequately represent the population they are researching.
...
Maryland had 223 aces, which puts them in the 95th percentile. This means they achieved more aces than 95% of teams.
...
The distribution is skewed to the left. 68% of the data falls within the lines, which is the first standard deviation.
