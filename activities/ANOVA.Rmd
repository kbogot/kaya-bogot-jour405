...
The data shows that the average SAT score is higher for student enrolled at private universities, while community college students had the lowest average. Private schools also have a smaller standard deviation, meaning that they had less distribution, less variation in scores.
...
Yes, Private colleges have higher average scores, while community has lower average scores.
2. Which specific college types differ from each other?
Public and private differ the most, their number is much more significant than the others.
3. How large are these differences?
-74.40438 (or 2.13-05 for p adj).
...
Headline:
Private colleges accept higher average SAT scores than public colleges.

Lead graph:
Data found a significant difference in the average SAT scores accepted at public versus private colleges. The average for public colleges was approximately 74 points lower than that of public schools. This comparison is much more significant than that between community colleges.
