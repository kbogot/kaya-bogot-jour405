...
One thing I noticed that raised concren was that around 55% of respondents identified as female, while 38% identified as men. However, if you compare this to the actual demographics of students at UMD (Ex. Spring 2024), around 49% identify as female, while 50% identify as male. Therefore, the responses from this survey do not accurately represent the population. 
Additionally, more faaculty/staff than students responded to this survery, which is also not representative of the whole population.
...
1. What is the range of weights in this dataset? **The rango of this data set spans from 0.2298 to 3.0386, so the range is 2.8088.**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **A weight of 0.23 means that the respondent is overrepresented and count as less than one person. A weight of 3.04 means that a respondent is underrepresented and counts as more than one person.**

3. Why might some respondents be weighted more heavily than others? **Some might be over or under represented based on the demographics of the respondent. So example, if they are a part of a minority group, they may historically be under represented in certain voting demographics.**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **The biggest difference was with "rarely/never" voters.:**

2. How might these differences affect reporting on likely voter turnout? **Yes, because for for "yes" respondents,  the negative number means they have a lower weighted percentage and will be underrepresented, they won't end up voting. While the number for "no" respondents is positive, it has a higher weighted percentage and is overrepresented. Basically, despite saying they do plan on voting, the majority of "rarely/never" voters don't end up voting.**

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **These differerences likely exist because people want to vote, but end up forgetting or not being able to. Whether that's due to transportation, ability to take time off, etc, may contribute to this underrepresentation in voters.:**
