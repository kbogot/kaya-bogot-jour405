...
total_rate = grand_total/population * 10000) |>
  select(year, violent_rate, property_rate, total_rate)
...
The year with the highest total rate was 1980, while the year 2020 had the lowest total rate. This matches my expectation due to the political climates at the times. The 80s were a time where the were several political issues driving public outrage, including the Cold War, the HIV/AIDS crisis, the rise of the "New Right," and more. 
On the other hand, it's much more obvious why the lowest crime rate was 2020. This was the year of the Covid-19 pandemic and for a majority of the year, people were confined to their homes.
