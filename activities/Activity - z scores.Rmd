...
We observed that there seems to be overwhelming amount of overdose calls in 2022 compared to 2023. The most calls came on Oct. 4, 2022.
...
The z-scores back up our observations from Task 3: Oct. 4, 2022 had the highest score, signifying that it was unusually high. Along with other days that had high call volume.
...
The day with the highest call volume was Saturday. It had an unusually high call volume compared to the average daily call volume.
...
On angle I might examine is that New Year's Day, 2023, had an unusually high call volume for overdose reports. It might be interesting to see if that was related to the holiday and anything specific that year.
Next steps would be to research about other years, and also drug and alcohol sales to see if they went up as well.
