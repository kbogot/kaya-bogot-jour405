...
This model is useful because it breaks down different aspect of football scores and compares them statistically to better measure significant outcomes. This is done through coefficients and measuring significant or insignificant changes.
...
Based on the model, points scored had the biggest impact on wins. It has the most significant p-value. Yards gained does not have much of an impact.

## Using the Model

Without using the words "multiple regression model", describe how you could use this model to cover a team or game.

We can use this model to compare different factors and their significance. This chart in particular seems to indicate that there is a strong correlation between points scored and yards gained, leading to a higher impact on wins.
When covering a game, you could track what elements impact the number of wins. So for basketball, you could look at steals, layups, 3-pointers, etc, and compare which factors lead are more significant in a winning outcome.
