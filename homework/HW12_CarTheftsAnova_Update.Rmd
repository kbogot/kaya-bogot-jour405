...
The average rate shows us how thefts are distributed by the population. So we can see from the data that during the spike, there was a much higher rate of theft. After the spike, theft still remained higher than pre-spike.: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
This chart shows a trend line of thefts from around 2018 to the present. We can see that around 2023, there was a massive spike, which has also skewed the average.
A better title would be, "Car thefts hit a massive car high in 2023."
...
- **Null Hypothesis (H0)**:   Over three time periods, the rate of car thefts was constant.

- **Alternative Hypothesis (H1)**: Over three time periods, the rate of car thefts varied.
...
The f-value (218) is huge, meaning that there is a lot of variance between the time periods.Since the p-value is very low, that means that the differences are statistically significant, andf the 3 astericks back that up, indicating that the significant level is 0.0001. Therefore, we can say with confidence that there is a real difference between time periods.
...
The Tukey test indicates that the largest difference is between the pre-spike year and the spike year (diff being 36.75536). With the chart, you can more easily visualize this difference. This is a significant difference.
Additionally, the pre-spike/post-spike difference is significant. (diff being -20.13231).

Headline:
Car theft rates remain significantly higher than before a spike in 2023.

Lede:
Data indicates that the rate of car thefts has gone up by about 20 points per ca-pita since before 2023. A spike in 2023 saw a larger difference of nearly 37 points. Post-spike, the number has not gone down to pre-spike numbers, but is about 16 point lower than it's peak.
