...
Education levels might vary because of willingness/interest in participating in a survey. The highest percentage of participants came from those with a higher education level. That indicates that those with a higher education level may be more interested in participating in research.
...
People with higher levels of education have a higher intention of voting.
...
They changed very slightly. The group with the biggest change was "High school or less.".

2. Why might the weighted results be considered more accurate than the unweighted results?

They better represent the population and how the data is structured.
...
It's important because it helps the journalist understand the population better, this then reflects in the data. Therefore, helping them more profoundly understand their results and thesignificance.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

It would help you more accurately reflect your population. Especially because a group like "High school or less" had a more significant change between Weighted and Unweighted
...
I would want to look more into the methodology and confirm that the weights accurately represent the population.
