...
Of course more serious crimes like murder, assault and shootings are more important than robbery or B & E crimes, however, it doesn't make those crimes less important to those experiencing them. Additionally, the data was mostly consistent, it was difficult to tell if there were many significant increase or decreases over the course of the year. This makes it a bit difficult if you are trying to report on changes made in the county, if perhaps precautions where taken to combat some of these crimes. It's worth noting that Residential Robbery has 2 months with no data, this will disrupt how totals and averages are calculated.
...
mutate(average_incidents = total_incidents/12) |>
 select(category, average_incidents)
...
Accidents had the highest averages, while homicides had the lowest. This tells me that serious crimes are very rare, while more mundane ones like accidents happen more often. I was interested in the category of assault shooting, I wonder if any of those are connected to homicides, or if they are seperate based on fatality.
...
summer_crime_averages <- pg_crime_averages |> 
  mutate(average_incidents = rowSums(across(2:13)) / 12,
   ...
   select(category, june_change, july_change, august_change)
```
...
Crimes against properties had more negative percent changes that crimes against people. This could be because more people are out and about outside rather than inside. Additionally, there are more people in general not being kept inside, for exmaple students, they are not in school and therefore could be commiting some of these crimes too.
...
Commercial Robbery seemed to decrease throughout the year. While not exactly linear, if you weigh the data, the second half of the year saw nearly a third less incidents of this kind. While this isn't nearly as important as say, murder, its interesting because it sparks curiosity as to what may have changed throughout the year. 
