...
The distribution of danceability scores on Spotify is skewed to the left. This tells us that the majority of the songs in the dataset (including the 68% in the first standard deviation), have a danceability score above 0.5. 
As a story, I'd like to investigate how these danceability scores compare to previous years. Where they higher in 2020 because people were looking for more upbeat during the pandemic? Does the skew of the danceability histogram reflect the general public attitude based on events in that year? Based on the histogram, these are ideas I'd like to explore.
