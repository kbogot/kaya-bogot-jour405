...
```{r}
GDP_data <- read.csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/gdp_djia.csv")
```
...
The relationship is linear, they have a strong correlation. Meaning they are closely related in some capacity. As one increases, so does the other. The scatter plot shows this relationship.
