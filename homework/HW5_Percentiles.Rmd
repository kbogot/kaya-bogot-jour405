...
md_cities_percentiles <- md_cities_rates |>
  ...
  nrow(md_cities_percentiles)

```

```{r}
md_cities_percentiles |>
  summarize(IQR_violent_rate_2020 = IQR(percentile))

```
This new information doesn't necessarily make me want to change my story idea, however, it has given me additionally ideas.
This more precise sorting allows me to look at exactly which cities had higher crime rate in 2020, therefore it will be easier to know which cities might be worth investigating further and writing a story about. One thing worth investigating is Wicomico county, this was the only county where 2 cities where over the 90th percentile.
